export const Bio = {
  ...
  description:
    "Competent MERN Stack Developer having 3+ years of hands-on experience in developing high-quality web applications. Proficient in Next.js/React.js, TypeScript, Agentic AI, Generative AI, JavaScript, Tailwind, Node.js, Express.js, MongoDB. Having ability to design and implement scalable solution for challenging assignments. Would love to deliver exceptional work that exceed expectations.",
  github: "https://github.com/umedsingh98",
  resume:
    "https://drive.google.com/file/d/1dupZn4ULm8lzyu_OwFzRcYCruhO5SPeR/view?usp=sharing",
...
export const education = [
  {
    ...
    grade: "63%",
    desc: "I have completed my B.Tech in Computer Science from The Technological Institute Of Textile & Sciences, Bhiwani in year 2021.",
  ...
  },
  {
    ...
    grade: "59%",
    desc: "I completed my class 12 high school education at The Technological Institute Of Textile & Sciences, Bhiwani",
  ...
  },
  {
    ...
    grade: "67%",
    desc: "I completed my class 10 education at The Technological Institute Of Textile & Sciences, Bhiwani",
    degree: "Secondary ",
  },
];
...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Created a dynamic and responsive web application using the MERN stack (MongoDB, Express, ReactJs, Node.js). The app includes multiple user routes: Home, Explore, Contact Us, About Us, Login, and Sign Up. Implemented JWT authentication to protect sensitive routes and ensure secure user sessions. Leveraged MongoDB for dynamic data management, allowing real-time updates and seamless integration of book data. This project highlights my proficiency in full-stack development and commitment to creating secure, user-centric web solutions.",
    image: "/bookpoint.png",
    tags: [
      "React Js",
      "MongoDB",
